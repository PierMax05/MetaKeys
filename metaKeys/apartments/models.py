...
class Apartment(models.Model):
    ...
    get_guest_info = models.BooleanField(default=False)
    get_document_photo = models.BooleanField(default=False)
    get_billing_info = models.BooleanField(default=False)
